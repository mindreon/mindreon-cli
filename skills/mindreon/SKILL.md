...
metadata: {"openclaw":{"emoji":"🚀","install":[{"id":"node","kind":"node","package":"@mindreon/mindreon-cli","bins":["mindreon"],"label":"Install mindreon CLI (node)"}]}}
---
...
可以通过 `npm link` 或 `npm i -g @mindreon/mindreon-cli` 安装全局命令 `mindreon`。
